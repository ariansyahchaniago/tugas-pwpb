...
<html lang="en">
  ...
  <nav class="navbar navbar-light sticky-top mb-5" style="background-color: #595b5c;">
            <div class="container text-center">
                <span class="navbar-brand h1 p-2 fw-bold text-light">Edit Gallery</span>
            </div>
        </nav>
  ...
  <div class="container" style="margin-top: 90px;">
            ...
            <form action="editgallery.php" method="POST">
                <div>
                      ...
                      <button class="btn mt-3 mb-3 ms-5 btn btn-success" style="width: 10%;" name="editg" value="edit">Edit</button>
